...
#Setando a aparecencia padrao do sistema
...
class App(ctk.CTk):
    ...
    def appearence(self):
        self.lb_ap = ctk.CTkLabel(self, text='Tema', bg_color='transparent', text_color=['#000','#fff']).place(x=50, y=430)
    ...
    def todo_sistema(self):
        ...
        title = ctk.CTkLabel(frame, text='Sistema de Gestão de Clientes', font=('Century Gothic bold',24), text_color='#fff').place(x=190, y=15)
        ...
        lb_contact = ctk.CTkLabel(self, text='Contacto', font=('Century Gothic bold',16), text_color=['#000','#fff'])
